...
public class CdcActionITCaseBase extends ActionITCaseBase {
    ...
    public void setEnv() {
        ...
        env.getCheckpointConfig().setCheckpointTimeout(TimeUnit.HOURS.toMillis(12));
    }
    ...
    protected void waitForResult(
        ...
        while (true) {
            ...
            if (sortedExpected.equals(sortedActual)) {
                LOG.info("Found result for table {}", table.name());
                sortedActual.forEach(System.out::println);
                break;
            }
            Thread.sleep(1000);
        }
