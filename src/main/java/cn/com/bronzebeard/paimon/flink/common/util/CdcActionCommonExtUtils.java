...
public class CdcActionCommonExtUtils {

    private static final Logger LOG = LoggerFactory.getLogger(CdcActionCommonExtUtils.class);
    ...
    public static Schema buildPaimonSchema(
        ...
        // primary keys
        if (CollectionUtils.isNotEmpty(specifiedPrimaryKeys)) {
        ...
        } else if (CollectionUtils.isNotEmpty(sourceSchema.primaryKeys())) {
        ...
        // partition keys
        if (CollectionUtils.isNotEmpty(specifiedPartitionKeys)) {
